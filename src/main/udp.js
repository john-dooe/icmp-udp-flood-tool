...
var target_port = parseInt(process.argv[3]);
var bytes = parseInt(process.argv[4]);
var sleep_time = parseInt(process.argv[5]);
var process_num = parseInt(process.argv[6]);
var processes_list = [];
...
var buffer = Buffer.from('A'.repeat(bytes), 'utf-8');
