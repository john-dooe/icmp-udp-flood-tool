...
const bytes = parseInt(process.argv[3]);
const sleep_time = parseInt(process.argv[4]);
const process_num = parseInt(process.argv[5]);
...
const buffer = Buffer.from('0800000000010a09' + '61'.repeat(bytes), 'hex');
